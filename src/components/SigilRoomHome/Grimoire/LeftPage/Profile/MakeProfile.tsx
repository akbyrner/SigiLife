  ...
  return (
    <div className='main-container'>
      <div className='makeprofile'>
        ...
        <form onSubmit={(e) => { e.preventDefault(); setValidated(true); handleHomeLocation }}>
        ...
        {validated && (<GoogleAuth setUser={setUser} formData={{username, avatar, theme, homeLatitude, homeLongitude}} />)}
